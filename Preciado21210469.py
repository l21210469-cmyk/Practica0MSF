...
print(f"El valor del capacitor Cr es de {Cr} Faradios.\n")
print(f"El valor del resistor Re es de {Re} Ohms.\n")
print(f"El valor del resistor Rr es de {Rr} Ohms.\n")
print(f"El valor del capacitor Ce es de {Ce} Faradios.\n")
...
_,PAu3 = ctrl.forced_response(sys,t,u3,x0) #Respuesta en lazo abierto al rampa
_,PAu4 = ctrl.forced_response(sys,t,u4,x0) #Respuesta en lazo abierto al funcion sinosoidal
...
_,pidu3 = ctrl.forced_response(sysPID,t,u3,x0) #Respuesta en lazo cerrado al rampa
_,pidu4 = ctrl.forced_response(sysPID,t,u4,x0) #Respuesta en lazo cerrado al funcion sinosoidal
...
fg3 = plt.figure() #Respuesta la rampa 
...
fg4 = plt.figure() #Respuesta la rampa 
